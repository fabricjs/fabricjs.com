...
> **new Brightness**(`options`?): [`Brightness`](Brightness.md)
...
> **`static`** **defaults**: `Partial`\<[`TClassProperties`](../../../type-aliases/TClassProperties.md)\<[`Brightness`](Brightness.md)\>\> = `brightnessDefaultValues`
