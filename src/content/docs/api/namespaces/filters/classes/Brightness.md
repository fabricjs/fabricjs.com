...
- [`BaseFilter`](/api/namespaces/filters/classes/basefilter/)\<`"Brightness"`, `BrightnessOwnProps`\>
...
• **options?**: `object` & `Partial`\<`BrightnessOwnProps`\> & `Record`\<`string`, `any`\> = `{}`
...
[src/filters/Brightness.ts:31](https://github.com/fabricjs/fabric.js/blob/v6.0.0-rc4/src/filters/Brightness.ts#L31)

***

### defaults

> `static` **defaults**: `BrightnessOwnProps` = `brightnessDefaultValues`
...
[src/filters/Brightness.ts:35](https://github.com/fabricjs/fabric.js/blob/v6.0.0-rc4/src/filters/Brightness.ts#L35)
...
[src/filters/Brightness.ts:33](https://github.com/fabricjs/fabric.js/blob/v6.0.0-rc4/src/filters/Brightness.ts#L33)
...
[src/filters/Brightness.ts:37](https://github.com/fabricjs/fabric.js/blob/v6.0.0-rc4/src/filters/Brightness.ts#L37)
...
[src/filters/Brightness.ts:49](https://github.com/fabricjs/fabric.js/blob/v6.0.0-rc4/src/filters/Brightness.ts#L49)
...
[src/filters/Brightness.ts:39](https://github.com/fabricjs/fabric.js/blob/v6.0.0-rc4/src/filters/Brightness.ts#L39)
...
[src/filters/Brightness.ts:58](https://github.com/fabricjs/fabric.js/blob/v6.0.0-rc4/src/filters/Brightness.ts#L58)
...
[src/filters/Brightness.ts:68](https://github.com/fabricjs/fabric.js/blob/v6.0.0-rc4/src/filters/Brightness.ts#L68)

***

### toJSON()

> **toJSON**(): `object` & `BrightnessOwnProps`

Returns a JSON representation of an instance

#### Returns

`object` & `BrightnessOwnProps`
...
> **toObject**(): `object` & `BrightnessOwnProps`
