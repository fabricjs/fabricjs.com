...
• **SProps** extends [`SerializedLineProps`](../interfaces/SerializedLineProps.md) = [`SerializedLineProps`](../interfaces/SerializedLineProps.md)
...
> **new Line**\<`Props`, `SProps`, `EventSpec`\>(`points`?, `options`?): [`Line`](Line.md)\<`Props`, `SProps`, `EventSpec`\>

Constructor

#### Parameters

• **points?**: [`number`, `number`, `number`, `number`]= `undefined`
...
[`Line`](Line.md)\<`Props`, `SProps`, `EventSpec`\>
...
• **\_\_namedParameters**: `Pick`\<[`Line`](Line.md)\<`Props`, `SProps`, `EventSpec`\>, `"fill"`\>
...
• **decl**: `Pick`\<[`Line`](Line.md)\<`Props`, `SProps`, `EventSpec`\>, `"strokeDashOffset"` \| `"strokeLineCap"` \| `"strokeLineJoin"` \| `"strokeMiterLimit"` \| `"strokeWidth"` \| `"stroke"`\>
...
> **clone**(`propertiesToInclude`?): `Promise`\<[`Line`](Line.md)\<`Props`, `SProps`, `EventSpec`\>\>
...
`Promise`\<[`Line`](Line.md)\<`Props`, `SProps`, `EventSpec`\>\>
...
• **T** extends [`Line`](Line.md)\<`Props`, `SProps`, `EventSpec`\>
...
if parent is canvas then this property is identical to [getX](Line.md#getx)
...
if parent is canvas then this property is identical to [getY](Line.md#gety)
...
> **set**(`key`, `value`?): [`Line`](Line.md)\<`Props`, `SProps`, `EventSpec`\>
...
• **T** extends `Omit`\<`Props` & [`TClassProperties`](../type-aliases/TClassProperties.md)\<[`Line`](Line.md)\<`Props`, `SProps`, `EventSpec`\>\>, keyof `SProps`\>
...
> **toggle**(`property`): [`Line`](Line.md)\<`Props`, `SProps`, `EventSpec`\>
...
> **`static`** **fromElement**(`element`, `options`?, `cssRules`?): `Promise`\<[`Line`](Line.md)\<`Object`, [`SerializedLineProps`](../interfaces/SerializedLineProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>
...
`Promise`\<[`Line`](Line.md)\<`Object`, [`SerializedLineProps`](../interfaces/SerializedLineProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>
...
src/shapes/Line.ts:242

***

### fromObject()

> **`static`** **fromObject**\<`T`\>(`object`): `Promise`\<[`Line`](Line.md)\<`Partial`\<[`FabricObjectProps`](../interfaces/FabricObjectProps.md)\>, [`SerializedLineProps`](../interfaces/SerializedLineProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>

Returns Line instance from an object representation

#### Type parameters

• **T** extends [`TOptions`](../type-aliases/TOptions.md)\<[`SerializedLineProps`](../interfaces/SerializedLineProps.md)\>
...
`Promise`\<[`Line`](Line.md)\<`Partial`\<[`FabricObjectProps`](../interfaces/FabricObjectProps.md)\>, [`SerializedLineProps`](../interfaces/SerializedLineProps.md), [`ObjectEvents`](../interfaces/ObjectEvents.md)\>\>
