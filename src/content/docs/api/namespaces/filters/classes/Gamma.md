...
- [`BaseFilter`](/api/namespaces/filters/classes/basefilter/)\<*typeof* `GAMMA`, `GammaOwnProps`\>

## Constructors

### new Gamma()

> **new Gamma**(`options`): [`Gamma`](/api/namespaces/filters/classes/gamma/)

#### Parameters

• **options** = `{}`

• **options.gamma?**: `GammaInput`
