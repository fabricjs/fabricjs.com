...
(function(global) {
  ...
  fabric.Path = fabric.util.createClass(fabric.Object, /** @lends fabric.Path.prototype */ {
    ...
    _initializePath: function (options) {
      ...
      this._setWidthHeight(options);
      this._setTopLeft(options);

      this.pathOffset = this.pathOffset ||
        // Save top-left coords as offset
        this._calculatePathOffset(this.left || 0, this.top || 0);
    },

    /**
     * @private
     */
    _setTopLeft: function(options) {
      if (!('top' in options)) {
        this.top = (this.height || 0) / 2;
      }
      if (!('left' in options)) {
        this.left = (this.width || 0) / 2;
      }
    },

    /**
     * Sets center location relative to given height/width if not specified
     * @private
     */
    _setWidthHeight: function(options) {
  ...
  fabric.util.object.extend(fabric.IText.prototype, /** @lends fabric.IText.prototype */ {
    ...
    initMousemoveHandler: function() {
      this.on('mousemove', function(options) {
        ...
        this.setSelectionEnd(this.getSelectionStartFromPointer(options.e));
      });
    },
