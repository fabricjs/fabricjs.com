/* build: `node build.js modules=text,cufon,gestures,easing,freedrawing,interaction,serialization,image_filters,gradient,pattern,shadow,node minifier=uglifyjs` */
