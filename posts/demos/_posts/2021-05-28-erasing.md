...
Follow this [link](https://gist.github.com/ShaMan123/6c5c4ca2cc720a2700848a2deb6addcd) to support v1 json payload. If you don't have v1 json you're good to go.
...
The erasers of objects in stake (`erasable` objects that intersect the created path) are updated.\
