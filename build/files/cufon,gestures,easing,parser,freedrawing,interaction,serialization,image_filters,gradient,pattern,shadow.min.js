/* build: `node build.js modules=cufon,gestures,easing,parser,freedrawing,interaction,serialization,image_filters,gradient,pattern,shadow minifier=uglifyjs` */
