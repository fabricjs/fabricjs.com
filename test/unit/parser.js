(function(){
  ...
  test('parseTransformAttribute', function() {
    ...
    parsedValue = fabric.parseTransformAttribute(element.getAttribute('transform'));
    parsedValue[2] = toFixed(parsedValue[2], 8);
    deepEqual(parsedValue, [1,0,0.03492077,1,0,0]);

    element.setAttribute('transform', 'skewY(234.111)');
    parsedValue = fabric.parseTransformAttribute(element.getAttribute('transform'));
    parsedValue[1] = toFixed(parsedValue[1], 8);
    deepEqual(parsedValue, [1,1.38200434,0,1,0,0]);
    ...
    parsedValue = fabric.parseTransformAttribute(element.getAttribute('transform'));
    parsedValue[2] = toFixed(parsedValue[2], 8);
    deepEqual(parsedValue, [2,0,0.39673622,13,10,195]);
  });
