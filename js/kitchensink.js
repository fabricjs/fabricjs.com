(function(global) {
  ...
  // canvas.backgroundColor = 'rgb(42,63,6)';
  var fontFamily = 'Hoefler Text', fontSize = 50;
  ...
  // var child2 = new fabric.Rect({ width: 20, height: 30, fill: 'yellowgreen', top: 15, left: 140 });

  // var group = new fabric.Group([ child1, child2 ], {
  //   top: 100,
  //   left: 250
  // });
  // canvas.add(group);

  // child1.on('mousedown', function () {
  //   console.log('child 1 down');
  // });
  // child2.on('mousedown', function () {
  //   console.log('child 2 down');
  // });
