...
(function() {
  ...
  fabric.Canvas = fabric.util.createClass(fabric.StaticCanvas, /** @lends fabric.Canvas.prototype */ {
     ...
     * @param {Boolean} silent When true, events are not fired
     * @return {fabric.Canvas} thisArg
     * @chainable
     */
    discardActiveObject: function () {
      this.fire('before:selection:cleared', { target: this._activeObject });
    ...
    setActiveGroup: function (group) {
      ...
      group && this.fire('object:selected', { target: group });
      return this;
    },
    ...
    discardActiveGroup: function () {
      this.fire('before:selection:cleared', { target: this._activeGroup });
